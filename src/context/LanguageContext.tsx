...
const translations: Record<Language, Translations> = {
  it: {
    metaTitle: "DGM Apps",
    metaDescription: "App utili e semplici pensate per farti risparmiare tempo: Kado AI, Bricolo AI, Forma AI, Calibro AI.",
    aboutUs: "Chi siamo",
    catalog: "Catalogo",
    contact: "Contatti",
  ...
  en: {
    metaTitle: "DGM Apps",
    metaDescription: "Useful, simple apps built to save you time: Kado AI, Bricolo AI, Forma AI, Calibro AI.",
    aboutUs: "About Us",
    catalog: "Catalog",
    contact: "Contact",
    allApps: "All Apps",
  ...
  es: {
    metaTitle: "DGM Apps",
    metaDescription: "Apps útiles y simples pensadas para ahorrarte tiempo: Kado AI, Bricolo AI, Forma AI, Calibro AI.",
  ...
  fr: {
    metaTitle: "DGM Apps",
    metaDescription: "Des applications utiles et simples pensées pour vous faire gagner du temps : Kado AI, Bricolo AI, Forma AI, Calibro AI.",
    aboutUs: "À Propos",
    catalog: "Catalogue",
    contact: "Contact",
  ...
  de: {
    metaTitle: "DGM Apps",
    metaDescription: "Nützliche, einfache Apps, die dir Zeit sparen: Kado AI, Bricolo AI, Forma AI, Calibro AI.",
    aboutUs: "Über Uns",
    catalog: "Katalog",
    contact: "Kontakt",
    allApps: "Alle Apps",
